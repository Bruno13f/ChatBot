...
const H0: React.FC<Props> = ({className, children}) => {
    return (
...
const H1: React.FC<Props> = ({className, children}) => {
    return (
      <h1 className={`scroll-m-20 text-3xl font-extrabold tracking-tight lg:text-4xl ${className}`}>
        {children}
      </h1>
    )
  }
  ...
  export { H0, H1, H2, H3, H4, P, Lead, Large, Muted, Blockquote, InlineCode}